...
//    public static final String TITLE_NULL = "Book title should not be null";
    public static final String TITLE_EMPTY = "Book title should not be empty";
//    public static final String AUTHOR_NULL = "Book author should not be null";
    public static final String AUTHOR_EMPTY  = "Book author should not be empty";
//    public static final String GENRE_NULL = "Book genre should not be null";
